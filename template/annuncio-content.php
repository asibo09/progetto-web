        ...
        <div class="col-12 col-lg-8">
                        ...
                        <div id="carouselAnnuncio" class="carousel slide h-100" data-bs-ride="false">
                            <div class="carousel-inner h-100">
                                ...
                                <div class="carousel-item <?php echo $idx == 0 ? 'active' : ''; ?> h-100">
                                    <img src="<?php echo $f['percorso_immagine']; ?>" alt="Foto <?php echo $idx + 1; ?>" class="img-fit h-100 w-100">
                                </div>
                                <?php endforeach; ?>
                            </div>
            ...
            <div class="d-flex justify-content-between align-items-start mb-1">
                <div>
                    ...
                    <p class="text-muted mb-0"><i class="bi bi-geo-alt-fill me-1 text-danger"></i><?php echo $a["comune"]; ?></p>
                </div>
                <div class="text-end">
            ...
            <div class="row g-3 mb-5 text-black fw-semibold">
                <div class="col-6 col-md-4"><i class="bi bi-door-open fs-4 me-2"></i><?php echo $a["nr_locali_totali"]; ?> locali</div>
                <div class="col-6 col-md-4"><i class="bi bi-aspect-ratio fs-4 me-2"></i><?php echo $a["superficie_totale"]; ?> m²</div>
                <div class="col-6 col-md-4"><i class="bi bi-badge-wc fs-4 me-2"></i><?php echo $a["nr_bagni_totali"]; ?> bagni</div>
                <div class="col-6 col-md-4"><i class="bi bi-layers fs-4 me-2"></i>Piano <?php echo $a["piano_alloggio"] == 0 ? "Terra" : $a["piano_alloggio"]; ?></div>
                <div class="col-6 col-md-4"><i class="bi bi-arrows-vertical fs-4 me-2"></i><?php echo $a["has_ascensore"] ? "Sì Ascensore" : "No Ascensore"; ?></div>
            </div>
        ...
        <div class="col-12 col-lg-4">
            <div id="utente-section" class="sticky-top anchor-section" style="top: 80px;">
                <div class="card shadow-sm border-0 p-4 rounded-4 mb-3 bg-white">
                    ...
                    <p class="mb-2"><i class="bi bi-envelope me-2"></i><strong>Email:</strong> <a href="mailto:<?php echo $a["email"]; ?>" class="text-dark"><?php echo $a["email"]; ?></a></p>
