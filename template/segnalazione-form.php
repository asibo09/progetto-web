...
<?php if($templateParams["errore_dati"]): ?>
    <div class="alert alert-warning mx-3 mt-5 shadow-sm border-start border-4 border-warning" role="alert">
        <div class="d-flex">
            <em class="bi bi-exclamation-triangle-fill fs-2 me-3"></em>
            <div>
...
<div class="mb-4 mt-5 text-left px-3">
    <h1 class="fw-bold"><em class="bi bi-exclamation-triangle text-danger me-2"></em>Invia una segnalazione</h1>
    <p class="text-muted">
        Stai segnalando: 
