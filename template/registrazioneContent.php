<div class="mb-4 mt-5 text-left px-3">
    <h1 class="fw-bold"><em class="bi bi-person-plus text-success me-2"></em>Registrazione</h1>
...
<form action="#" method="POST">
    ...
    <div class="mb-4">
        ...
        <input type="text" class="form-control" id="cellulare" name="cellulare"
            placeholder="Inserisci cellulare" required>
    </div>
    <div class="mb-4">
        <label for="eta" class="form-label fw-semibold fs-5">Eta</label>
        <input type="number" class="form-control" id="eta" name="eta" placeholder="Inserisci eta" required>
    </div>
    <div class="mb-4">
    ...
    <button type="submit" class="btn bg-unibo-red w-100 py-3 rounded-3 shadow-sm fw-bold fs-5">
        <em class="bi bi-person-plus-fill me-2"></em> REGISTRATI
    </button>
</form>
