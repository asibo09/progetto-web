                                    ...
                                    <div class="d-flex align-items-start gap-3">
                                        <div>
                                            ...
                                            <p class="mb-0 text-muted">Per appartamento in:
                                                <?php echo $richiestaSubaffitto['indirizzo']; ?>. Stanza: <?php echo $richiestaSubaffitto['id_stanza']; ?>. Descrizione:<?php echo $richiestaSubaffitto['tipo_immobile']; ?>
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <article class="bg-white border p-4 mb-4 rounded-3 shadow-sm">
                                <header class="d-flex justify-content-between align-items-center mb-3">
                                    <div class="d-flex align-items-start gap-3">
                                        <div>
                                            <h2 class="h5 mb-1 fw-bold">Richiesta subaffitto</h2>
                                            <p class="mb-0 text-muted">Per stanza ID:
                                                <?php echo $richiestaSubaffitto['id_stanza']; ?> in
                                                <?php echo $richiestaSubaffitto['tipo_immobile']; ?>
                                            </p>
                                        </div>
                                    </div>
                                    <span class="badge rounded-pill bg-warning text-dark d-flex align-items-center">
                                ...
                                <div class="bg-light p-3 rounded-3 mb-3">
                                    <p class="mb-0 fst-italic">"
                                        <?php echo $richiestaSubaffitto['messaggio']; ?>"
                                    </p>
                                </div>
