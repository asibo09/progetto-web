<h1 class="fw-bold mb-5"><em class="bi bi-house me-2"></em>
                        ...
                        <div class="col-12 col-md-8">
                            <div class="card-body p-4 d-flex flex-column h-100">
                                ...
                                <p class="text-muted small mb-1">
                                    <em
                                        class="bi bi-geo-alt-fill me-1 text-danger"></em><?php echo $alloggio["indirizzo"] . ", " . $alloggio["comune"] ?>
                                </p>
                                ...
                                <div class="position-absolute bottom-0 end-0 m-3 z-3">
                                    <?php if ($alloggio["stato"] == 'Confermata'): ?>
                                        <a href="richiestaSubaffitto.php?id=<?php echo $alloggio["id_alloggio"] ?>"
                                            ...
                                            <em class="bi bi-arrow-left-right"></em> Subaffitta
                                        </a>
                                    <?php endif; ?>
                                </div>
                            </div>
