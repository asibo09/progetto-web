<div class="mb-5">
    <h1 class="fw-bold"><i class="bi bi-heart-fill text-danger me-3"></i>I miei annunci salvati</h1>
                                ...
                                <div class="carousel-inner h-100">
                                    ...
                                    <div class="carousel-item <?php echo $idx === 0 ? 'active' : ''; ?> h-100">
                                        <a href="annuncio.php?id=<?php echo $annuncio["id_alloggio"]; ?>" class="d-block h-100">
                                            <img src="upload/<?php echo $f['percorso_immagine']; ?>" class="img-fit-standard" alt="Foto Alloggio">
                                        </a>
                                    </div>
                                    <?php endforeach; ?>
                                </div>
