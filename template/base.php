...
<header class="d-none d-lg-flex justify-content-between align-items-center p-3 bg-unibo-red shadow-sm">
    <a <?php isActive("index.php");?> href="index.php">
    ...
    <nav class="d-flex gap-5 fs-5">
        ...
        <div class="vr bg-white" style="height: 30px; opacity: 1;"></div><a <?php isActive("preferiti.php");?> href="preferiti.php">Salvati</a>
        <div class="vr bg-white" style="height: 30px; opacity: 1;"></div><a <?php isActive("richiedi.php");?> href="richiedi.php">Richiedi</a>
        <div class="vr bg-white" style="height: 30px; opacity: 1;"></div><a <?php isActive("prenotazioni.php");?> href="prenotazioni.php">Prenotazioni</a>
    </nav>
...
<nav class="fixed-bottom bg-white border-top shadow d-md-none">
    <ul style="list-style: none; display: flex; justify-content: space-around; padding: 10px; margin: 0;">
        <li style="text-align: center;">
            <a <?php isActive("index.php");?> href="index.php" style="text-decoration: none; color: black;">
                <i class="bi bi-house" style="font-size: 24px;"></i>
                <p style="margin: 0; font-size: 0.8rem;">Home</p>
            </a>
        </li>
        <li style="text-align: center;">
            <a <?php isActive("preferiti.php");?> href="preferiti.php" style="text-decoration: none; color: black;">
                <i class="bi bi-heart" style="font-size: 24px;"></i>
                <p style="margin: 0; font-size: 0.8rem;">Salvati</p>
            </a>
        </li>
        <li style="text-align: center;">
            <a <?php isActive("richiedi.php");?> href="richiedi.php" style="text-decoration: none; color: black;">
                <i class="bi bi-plus-circle" style="font-size: 24px;"></i>
                <p style="margin: 0; font-size: 0.8rem;">Richiedi</p>
            </a>
        </li>
        <li style="text-align: center;">
            <a <?php isActive("prenotazioni.php");?> href="prenotazioni.php" style="text-decoration: none; color: black;">
