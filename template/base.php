...
<body class="d-flex flex-column min-vh-100">
        ...
        <nav class="d-flex gap-5 fs-5 align-items-center">
            <?php if (isUserLoggedInID()): ?>
                <?php if ($_SESSION["ruolo"] == 'studente'): ?>
                    ...
                    <div class="vr bg-white" style="height: 30px; opacity: 1;"></div>
                    <a <?php isActive("richiestaSubaffitto.php"); ?> href="richiestaSubaffitto.php"
                        aria-label="Richiedi subaffitto">Richiedi</a>
                    <div class="vr bg-white" style="height: 30px; opacity: 1;"></div>
                    <a <?php isActive("prenotazioni.php"); ?> href="prenotazioni.php"
                        aria-label="Le tue prenotazioni">Prenotazioni</a>
                <?php elseif ($_SESSION["ruolo"] == 'proprietario'): ?>
                    <a <?php isActive("index.php"); ?> href="index.php" aria-label="Home">Home</a>
                    <div class="vr bg-white" style="height: 30px; opacity: 1;"></div>
                    <a <?php isActive("preferiti.php"); ?> href="preferiti.php" aria-label="Salvati">Salvati</a>
                    <div class="vr bg-white" style="height: 30px; opacity: 1;"></div>
                    <a <?php isActive("pubblica-annuncio.php"); ?> href="pubblica-annuncio.php"
                        aria-label="Publlica annuncio">Pubblica</a>
                    <div class="vr bg-white" style="height: 30px; opacity: 1;"></div>
    ...
    <!-- Tablet -->
    <header
        class="d-none d-md-flex d-lg-none justify-content-between align-items-center p-3 bg-unibo-red shadow-sm text-white">
        ...
        <div class="d-flex gap-4 align-items-center">
            <?php if (isUserLoggedInID()): ?>
                ...
                <?php elseif ($_SESSION["ruolo"] == 'proprietario'): ?>
                    <a <?php isActive("preferiti.php"); ?> href="preferiti.php" title="Salvati"><em
                            class="bi bi-heart fs-4"></em></a>
                    <a <?php isActive("pubblica-annuncio.php"); ?> href="pubblica-annuncio.php" title="Pubblica annuncio"><em
            ...
            <ul style="list-style: none; display: flex; justify-content: space-around; padding: 10px; margin: 0;">
                <li style="text-align: center;">
                    <a href="index.php" class="text-dark text-decoration-none text-center d-block" aria-label="Home">
                        <em class="bi bi-house fs-4"></em>
                        <p class="m-0 small">Home</p>
                    </a>
                </li>
                <li style="text-align: center;">
                    <a href="preferiti.php" class="text-dark text-decoration-none text-center d-block" aria-label="Salvati">
                        <em class="bi bi-heart fs-4"></em>
                        <p class="m-0 small">Salvati</p>
                    </a>
                </li>
                <?php if ($_SESSION["ruolo"] == 'studente'): ?>
                    <li style="text-align: center;">
                        <a href="richiestaSubaffitto.php" class="text-dark text-decoration-none text-center d-block"
                            aria-label="Richiedi subaffitto">
                            <em class="bi bi-plus-circle fs-4"></em>
                            <p class="m-0 small">Richiedi</p>
                        </a>
                    </li>
                    <li style="text-align: center;">
                        <a href="prenotazioni.php" class="text-dark text-decoration-none text-center d-block"
                            aria-label="Le tue prenotazioni">
                            <em class="bi bi-calendar-event fs-4"></em>
                            <p class="m-0 small">Prenotazioni</p>
                        </a>
                    </li>
                <?php else: ?>
                    <li style="text-align: center;">
                        <a href="pubblica-annuncio.php" class="text-dark text-decoration-none text-center d-block"
                            aria-label="Pubblica annuncio">
                            <em class="bi bi-plus-circle fs-4"></em>
                            <p class="m-0 small">Pubblica</p>
                        </a>
                    </li>
                    <li style="text-align: center;">
                        <a href="iMieiAnnunci.php" class="text-dark text-decoration-none text-center d-block"
                            aria-label="I tuoi annunci">
                            <em class="bi bi-pin fs-4"></em>
                            <p class="m-0 small">Annunci</p>
                        </a>
                    </li>
                <?php endif; ?>
            </ul>
            ...
            <div class="modal-content">
                ...
                <form action="processa-prenotazione.php" method="POST">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" id="btn-conferma-prenota" class="btn btn-unibo-red text-white fw-bold"
    ...
    <script src="js/salva-ricerca.js"></script>
</body>
